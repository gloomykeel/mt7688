...
#define CONFIG_AUTOBOOT_PROMPT "Autobooting in:\t%d s (type 'qq' to run U-Boot console)\n\n"
#define CONFIG_AUTOBOOT_STOP_STR "qq"
...
#if 1 /* Web failsafe configuration */
